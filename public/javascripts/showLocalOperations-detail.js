...
if(localStorage.getItem('operationsUser') || localStorage.getItem('operationsFilter')) {
  ...
  let operationsBalance = JSON.parse(localStorage.getItem('operationsUser'));
  let balanceValue = document.querySelector('.wallet-balance');
  let incomes =  operationsBalance.filter(q => q.type == 'Income');
  let expenses =  operationsBalance.filter(e => e.type == 'Expense');
